        ...
        with os.scandir(path) as it:
            for entry in it:
                if entry.is_file():
                    ...
                    total += ZipUtils.get_directory_size(entry.path)
        return total
...
create_zip_archive = ZipUtils.create_zip_archive
extract_zip_archive = ZipUtils.extract_zip_archive
get_directory_size = ZipUtils.get_directory_size
format_size = ZipUtils.format_size
