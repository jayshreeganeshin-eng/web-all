...
class InvisibleContentEngine:
    ...
    DEFAULT_HOVER_SELECTORS = [".dropdown", ".menu-item", "[data-hover]", "nav li"]
    ...
    async def _submit_form(
        self, page: Page, submit_selector: str, input_values: Optional[Dict]
    ) -> bool:
    ...
    async def discover_sitemap_urls(self, base_url: str) -> List[str]:
        ...
        # Suppress XML parsing warning when using lxml for XML
